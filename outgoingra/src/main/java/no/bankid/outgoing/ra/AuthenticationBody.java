...
public class AuthenticationBody {
    ...
    @Schema(description = "Originator/bank-number for endUser's bankID, valid BankID ODS number",
            example = "9980")
    public String originator_id;
    @Schema(description = "EndUser's Norwegian national identification number, string of 11 digits",
            example = "11111111016")
    public String nnin;
}
